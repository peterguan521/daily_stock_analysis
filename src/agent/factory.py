...
def get_tool_registry():
    ...
    from src.agent.tools.credit_tools import ALL_CREDIT_TOOLS
    registry = ToolRegistry()
    for tool_fn in ALL_DATA_TOOLS + ALL_ANALYSIS_TOOLS + ALL_SEARCH_TOOLS + ALL_MARKET_TOOLS + ALL_BACKTEST_TOOLS + ALL_CREDIT_TOOLS:
